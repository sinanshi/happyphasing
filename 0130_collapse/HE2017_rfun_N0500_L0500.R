...
runBWPS_Diplo_Std_Pnl <- function(obs_smp, ref_pnl, theta, lambda, smp_dip_size) {
  ...
  for (i in 1:N_smp) {
    ...
    save(dip, file = "BWPS_Diplo_Std_Pnl_N0500_L0500.rda")
  }
...
runBWPS_Diplo_Red_Pnl_NA <- function(obs_smp, ref_pnl, bck_len, theta, lambda, smp_dip_size) {
  ...
  for (i in 1:N_smp) {
    ...
    save(dip, file = "BWPS_Diplo_Red_Pnl_NA_N0500_L0500.rda")
  }
  return(dip)
}
#' Compiled version
...
runBWPS_Diplo_Red_Pnl_FA <- function(obs_smp, ref_pnl, bck_len, theta, lambda, smp_dip_size) {
  ...
  for (i in 1:N_smp) {
    ...
    save(dip, file = "BWPS_Diplo_Red_Pnl_FA_N0500_L0500.rda")
  }
  return(dip)
}
#' Compiled version
...
runBWPS_Diplo_Red_Pnl_SA <- function(obs_smp, ref_pnl, bck_len, theta, lambda, smp_dip_size) {
  ...
  for (i in 1:N_smp) {
    ...
    save(dip, file = "BWPS_Diplo_Red_Pnl_SA_N0500_L0500.rda")
  }
  return(dip)
}
#' Compiled version
...
runBWPS_Diplo_Red_Pnl_TA <- function(obs_smp, ref_pnl, bck_len, theta, lambda, smp_dip_size) {
  ...
  for (i in 1:N_smp) {
    ...
    save(dip, file = "BWPS_Diplo_Red_Pnl_TA_N0500_L0500.rda")
  }
  return(dip)
}
#' Compiled version
